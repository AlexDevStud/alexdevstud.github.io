var swiper = new Swiper(".mySwiper", {
    ...
    dT[0].innerHTML = passed(2003, 2, 13, 0, 0  )[0];
    dT[1].innerHTML = 0;
    dT[2].innerHTML = passed(2003, 2, 13, 0, 0  )[1];
    dT[3].innerHTML = passed(2003, 2, 13, 0, 0  )[3];
    dT[4].innerHTML = passed(2003, 2, 13, 0, 0  )[4];
    dT[5].innerHTML = String(s);
    }, 1000);
    
var anim = document.querySelectorAll(".anim");

console.log(passed(2003, 2, 12, 0, 0 ));
